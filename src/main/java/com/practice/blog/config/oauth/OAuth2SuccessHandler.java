...
import com.practice.blog.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private final static Duration ACCESS_TOKEN_DURATION = Duration.ofDays(1);
    private final static String REDIRECT_PATH = "/articles";
